...
# Drop some indicators based on % of missing values
health.drop(['SH.STA.ANVC.ZS', 'SH.H2O.SAFE.ZS', 'SH.MMR.RISK.ZS', 'SH.DYN.AIDS.ZS', 'SH.TBS.INCD', 'SH.TBS.PREV', 'SH.MED.CMHW.P3', 'SL.UEM.TOTL.ZS', 'SH.CON.1524.MA.ZS', 'SH.CON.1524.FE.ZS', 'SH.XPD.PCAP', 'SH.IMM.HEPB', 'SH.PRG.SYPH.ZS', 'SH.PRV.SMOK.MA', 'SH.DTH.INJR.ZS', 'SH.STA.OW15.ZS','SH.DTH.COMM.ZS'], axis=1, inplace=True)
